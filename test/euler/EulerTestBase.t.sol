...
import {AssertionsCustomTypes} from "evk-test/helpers/AssertionsCustomTypes.sol";
import "evk-test/unit/evault/InvariantOverrides.sol";

import "evk/EVault/shared/Constants.sol";

contract EulerTestBase is AssertionsCustomTypes, Test, DeployPermit2 {
    ...
    function setUp() public virtual {
        ...
        integrations =
            Base.Integrations(address(evc), address(protocolConfig), sequenceRegistry, balanceTracker, address(permit2));
